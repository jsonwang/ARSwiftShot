...
class GameViewController: UIViewController {
    ...
    func preloadLevel() {
        os_signpost(.begin, log: .preload_assets, name: .preload_assets, signpostID: .preload_assets, "Preloading assets started")
        //os_signpost(type: .begin, log: .preload_assets, name: .preload_assets, signpostID: .preload_assets,"Preloading assets started")
